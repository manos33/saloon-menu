...
function handleSearch() {
  ...
  if (input.length > 0) {
    ...
    var elements = container.querySelectorAll('.item, .pinsa-item, .main-course-item, .burger-item, .ice-card, .platter-card, .sig-card, .promo-card, .happy-hour-card, .info-card');
    var matches = 0;
